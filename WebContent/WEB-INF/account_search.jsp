...
<div class="container-fluid">
	...
	<div class="row" style="background-color: #dbd9d9;">
		...
		<div class="col-md-6 part5">
			<div class="row"> 
				<div class="col-md-12"><h2>Account Search</h2></div>
				<div class="col-md-12">
					<form method="get" action="AccountSearch" class="form8">
			  			<div class="row part5sub2">
			  				<div class="col-md-6"><label for="AccId">Account Id<sup>*</sup></label></div>
        					<div class="col-md-6"><input type="text" id="AccId" name="AccId"></div>
        				</div>
        				<div class="row part5sub2 text-center">
			  				<div class="col-md-12"><p>OR</p></div>
           				</div>
        				<div class="row part5sub2">
			  				<div class="col-md-6"><label for="CId">Enter Customer Id<sup>*</sup></label></div>
        					<div class="col-md-6"><input type="text" id="CId" name="CId"></div>
        				</div>
        				<div class="row part5sub4">
                  			<div class="col-md-12"><p>(*)Either one of the details should be entered</p></div>
                		</div>
