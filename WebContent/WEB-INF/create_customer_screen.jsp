...
<div class="container-fluid">
	...
	<div class="row" style="background-color: #dbd9d9;">
		...
		<div class="col-md-6 part5">
			<div class="row"> 
				<div class="col-md-12"><h2>Create Customer</h2></div>
				<div class="col-md-12">
					<form method="get" action="CreateCustomer" class="form2">
			  			<div class="row part5sub2">
			  				<div class="col-md-6"><label for="CSsnId">Customer SSN Id<sup>*</sup></label></div>
        					<div class="col-md-6"><input type="text" id="CSsnId" name="CustomerSsnId"></div>
        				</div>
        				<div class="row part5sub2">
			  				<div class="col-md-6"><label for="CName">Customer Name<sup>*</sup></label></div>
        					<div class="col-md-6"><input type="text" id="CName" name="CustomerName"></div>
        				</div>
        				<div class="row part5sub2">
			  				<div class="col-md-6"><label for="Age">Age<sup>*</sup></label></div>
        					<div class="col-md-6"><input type="text" id="Age" name="CAge"></div>
        				</div>
        				<div class="row part5sub2">
			  				<div class="col-md-6"><label for="Address">Address<sup>*</sup></label></div>
        					<div class="col-md-6"><input type="text" id="Address" name="CAddress"></div>
        				</div>
        				<div class="row part5sub2">
			  				<div class="col-md-6"><label for="State">State<sup>*</sup></label></div>
        					<div class="col-md-6">
        						<select class="form-control"  id='State' name='CState' onClick="getState()"></select>
        					</div>
        				</div>
        				<div class="row part5sub2">
			  				<div class="col-md-6"><label for="City">City<sup>*</sup></label></div>
        					<div class="col-md-6">
        						<select class="form-control"  id='City' name='CCity' ></select>
        					</div>
        				</div>
